"""
Django settings for AlgoTradeService project.
...
from conf import DB_PORT, DB_NAME, DB_PASSWORD, DB_USER, DB_HOST, PAGE_SIZE
...
ROOT_URLCONF = 'AlgoTradeService.urls'
...
WSGI_APPLICATION = 'AlgoTradeService.wsgi.application'
